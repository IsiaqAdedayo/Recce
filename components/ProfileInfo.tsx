        ...
        <div className="col-span-3 lg:col-span-2 bg-white rounded pb-10 lg:pb-0 ml-6 md:ml-0">
            <div className="flex justify-between items-center bg-blue-100 pt-4 px-5 ">
                <div className="flex justify-between items-center pb-0 font-bold text-blue-300 space-x-5 overflow-x-scroll xl:overscroll-x-none xl:overflow-x-hidden text-sm lg:text-base">
                    <h1 className="cursor-pointer active:text-indigo-600 lg:pb-5 pb-1 border-b-4 border-transparent hover:border-indigo-600">TImeline</h1>
                    <h1 className="cursor-pointer active:text-indigo-600 lg:pb-5 pb-1 border-b-4 border-transparent hover:border-indigo-600">Notes</h1>
                    <h1 className="cursor-pointer active:text-indigo-600 lg:pb-5 pb-1 border-b-4 border-transparent hover:border-indigo-600">Events</h1>
                    <h1 className="cursor-pointer active:text-indigo-600 lg:pb-5 pb-1 border-b-4 border-transparent hover:border-indigo-600">Tasks</h1>
                    <h1 className="cursor-pointer text-indigo-600 border-b-4 border-indigo-600 lg:pb-5 pb-1">Deals</h1>
                    <h1 className="cursor-pointer active:text-indigo-600 lg:pb-5 pb-1 border-b-4 border-transparent hover:border-indigo-600">Campaigns</h1>
                    <h1 className="cursor-pointer active:text-indigo-600 lg:pb-5 pb-1 border-b-4 border-transparent hover:border-indigo-600">Web Stats</h1>
                    <h1 className="cursor-pointer active:text-indigo-600 lg:pb-5 pb-1 border-b-4 border-transparent hover:border-indigo-600">Mail</h1>
                    <h1 className="cursor-pointer active:text-indigo-600 lg:pb-5 pb-1 border-b-4 border-transparent hover:border-indigo-600">Documents</h1>
                </div>
                ...
                <div className="flex flex-col md:flex-row justify-between group w-full pt-4 pl-1 pr-3 md:px-5 rounded md:items-center border-l-4 border-blue-800 space-y-6 md:space-y-0">
                    <div className="flex space-x-3">
                        ...
                        <div className="text-sm md:text-base space-y-1">
                            ...
                            <div className="flex  flex-col xs:flex-row space-y-3 xs:space-y-0 text-xs justify-between  xs:space-x-2 md:text-sm ">
                                <h1 className="">$ 212 347 222</h1>
                                <div className="flex xs:flex-row flex-col xs:space-y-0 space-y-3 justify-between xs:space-x-3">
